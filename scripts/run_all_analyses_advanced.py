...
class AdvancedAnalysisRunner:
    ...
    def __init__(self, run_basic: bool = True, run_advanced: bool = True):
        ...
        self.basic_scripts = [
            "section_3_1_analysis_enhanced.py",  # 3.1节分析（增强版）
            "hypothesis_h1_analysis_publication.py",  # H1假设（发表版，含图形修复）
            "hypothesis_h2_analysis_publication.py",  # H2假设（发表版，Panel B高度修复）
            "hypothesis_h3_analysis_publication.py",  # H3假设（发表版，Panel A/C/D修复）
            "hypothesis_h4_analysis_publication.py"   # H4假设（发表版，所有面板修复）
        ]
